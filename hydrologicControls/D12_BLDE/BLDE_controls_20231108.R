######################################################################################################################## 
#' @title Stage-Discharge Rating Curve Controls Script - D12 - BLDE
...
#' discharge rating curve for Black Tail Deer Creek for water years 2023-.
...
#   Bobby Hensley (12/13/2023)
#     Modified for BLDE 2023 survey
######################################################################################################################## 
...
filepath <- "N:/Science/AQU/Controls/D12_BLDE_20231108"
...
surveyPtsDF <- read.table(paste0(URIpath,"/NEON_D12_BLDE_GEOMORPH_20181026_L0_VE/D12_BLDE_20231108_surveyPts.CSV"),
                          sep = ",",
                          header = TRUE,
...
dischargeXS1NorthStart<-dischargePointsXS1$N[dischargePointsXS1$name=="DSC_XS4"]
dischargeXS1EastStart<-dischargePointsXS1$E[dischargePointsXS1$name=="DSC_XS4"]
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS15"]
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS4"]
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS20"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_LBF"]
