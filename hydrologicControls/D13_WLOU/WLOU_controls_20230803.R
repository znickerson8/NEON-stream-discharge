...
#' discharge rating curve for West St. Louis Creek for water years 2023-.
...
filepath <- "N:/Science/AQU/Controls/D13_WLOU_20230803"

#Read in csv file
surveyPtsDF <- read.table(paste0(filepath,"/D13_WLOU_surveyPts_20230803.CSV"),
                          sep = ",",
                          header = TRUE,
...
geo_controlType_in$channelSlopeUnc[2] <- 0.048  #Default slope uncertainty is equal to slope
geo_controlType_in$channelSlope[3] <- rise/run
geo_controlType_in$channelSlopeUnc[3] <- 0.048 # Default slope uncertainty is equal to slope
