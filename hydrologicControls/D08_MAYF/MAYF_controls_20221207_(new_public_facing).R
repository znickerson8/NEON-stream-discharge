...
#   Bobby Hensley (2023-10-25)
#     Script for MAYF 2022-12-07 created.
...
dataFromAPI <- neonUtilities::loadByProduct(streamMorphoDPID,siteID,startdate="2022-12", enddate="2022-12",
...
floodplainPoint<-dsc_surveyPoints[1,]
floodplainPoint$surveyPointID="DSC_RFPLN_5"
floodplainPoint$northing=3647063+7.08
floodplainPoint$easting=461860+13.84
floodplainPoint$elevation=72.5
dsc_surveyPoints <- rbind(dsc_surveyPoints, floodplainPoint)
...
dscReference <- dsc_surveyPoints$distanceRaw[dsc_surveyPoints$surveyPointID=="DSC_LFPLN_1"]
...
staffGaugePoints<-staffGaugePoints[(staffGaugePoints$surveyPointID=="SP_0.95"),] #Survey has 0.95m shot of permanent and temporary gage, so grpl() won't work
staffGaugeElevation <- staffGaugePoints$elevation[grepl("SP_0.95",staffGaugePoints$surveyPointID)]  
...
geo_controlType_in$controlRight[1] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_REW"]
...
geo_controlType_in$controlLeft[2] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS4"]
geo_controlType_in$controlRight[2] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS_29"]
...
geo_controlType_in$controlLeft[3] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS_29"]
geo_controlType_in$controlRight[3] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_RFPLN_5"]
...
geo_priorParameters_in$priorActivationStage[1] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS_21"]
geo_priorParameters_in$priorActivationStageUnc[1] <- 0.1
geo_priorParameters_in$priorActivationStage[2] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS_23"]
geo_priorParameters_in$priorActivationStageUnc[2] <- 0.1 
geo_priorParameters_in$priorActivationStage[3] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_RFPLN_3"]
