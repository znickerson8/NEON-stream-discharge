...
#' discharge rating curve for Oksrukuyik Creek for water years 2023-
...
#     Modified for OKSR 2023 AIS survey
######################################################################################################################## 
...
filepath <- "N:/Science/AQU/Controls/D18_OKSR_20230803"

#Read in csv file
surveyPtsDF <- read.table(paste0(filepath,"/D18_OKSR_surveyPts_20230803.CSV"),
                          sep = ",",
                          header = TRUE,
...
staffGaugeElevation <- staffGaugePoints$H[grepl("SP_0.65M",staffGaugePoints$name)]  
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS22"]
geo_controlType_in$controlRight[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS31"]
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_MAX_LEW"]
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS27"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS14"]
