...
#   Bobby Hensley (2023-10-23)
#     Script for BLUE 2023-08-24 created.
...
dataFromAPI <- neonUtilities::loadByProduct(streamMorphoDPID,siteID,startdate="2023-08", enddate="2023-08",
...
staffGaugeElevation <- staffGaugePoints$elevation[grepl("SP_0.9",staffGaugePoints$surveyPointID)]  
...
geo_controlType_in$controlRight[1] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS_16"]
...
geo_controlType_in$controlRight[3] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_RFPLN_12"]
...
geo_priorParameters_in$priorActivationStage[1] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS_10"]
geo_priorParameters_in$priorActivationStageUnc[1] <- 0.1
geo_priorParameters_in$priorActivationStage[2] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS_8"]
