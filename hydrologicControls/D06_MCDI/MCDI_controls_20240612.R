...
#' discharge rating curve for McDiffet Creek for water years 2024-.
...
filepath <- "N:/Science/AQU/Controls/D06_MCDI_20240612"

#Read in csv file
surveyPtsDF <- read.table(paste0(filepath,"/D06_MCDI_surveyPts_20240612.CSV"),
                          sep = ",",
                          header = TRUE,
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_18S"]
geo_controlType_in$controlRight[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_3S"]
...
geo_priorParameters_in$priorActivationStage[1] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_10S"]
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_6S"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_RB_PIN"]
