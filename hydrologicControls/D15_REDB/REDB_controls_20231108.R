...
#' discharge rating curve for Red Butte Creek for water years 2023-.
...
filepath <- "N:/Science/AQU/Controls/D15_REDB_20231108"

#Read in csv file
surveyPtsDF <- read.table(paste0(filepath,"/D15_REDB_surveyPts_20231108.CSV"),
                          sep = ",",
                          header = TRUE,
...
dischargeXS1NorthStart<-dischargePointsXS1$N[dischargePointsXS1$name=="DSC_XS38"]
dischargeXS1EastStart<-dischargePointsXS1$E[dischargePointsXS1$name=="DSC_XS38"]
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS28"]
geo_controlType_in$controlRight[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS10"]
...
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS2"]
