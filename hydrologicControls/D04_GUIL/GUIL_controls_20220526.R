...
#' discharge rating curve for Rio Yahuecas for water years 2022-.
...
filepath <- "N:/Science/AQU/Controls/D04_GUIL_20220526"
...
surveyPtsDF <- read.table(paste0(URIpath,"/D04_GUIL_surveyPts_20220526.csv"),
                          sep = ",",
                          header = TRUE,
...
geo_controlType_in$controlRight[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS16"]
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS16"]
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS11"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS16"]
