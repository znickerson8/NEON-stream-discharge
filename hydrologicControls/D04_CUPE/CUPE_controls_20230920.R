...
#' discharge rating curve for Rio Cupeyes for water years 2023-.
...
filepath <- "N:/Science/AQU/Controls/D04_CUPE_20230920"

#Read in csv file
surveyPtsDF <- read.table(paste0(filepath,"/D04_CUPE_surveyPts_20230920.CSV"),
                          sep = ",",
                          header = TRUE,
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS31"]
geo_controlType_in$controlRight[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS22"]
...
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS11"]
