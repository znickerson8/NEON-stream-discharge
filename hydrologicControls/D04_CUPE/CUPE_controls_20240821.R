...
filepath <- "N:/Science/AQU/Controls/D04_CUPE_20240821"

#Read in csv file
surveyPtsDF <- read.table(paste0(filepath,"/D04_CUPE_surveyPts_20240821.CSV"),
                          sep = ",",
                          header = TRUE,
...
staffGaugeElevation <- staffGaugePoints$H[grepl("SP_0.60M_NEW",staffGaugePoints$name)]  
...
geo_controlType_in$controlRight[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS21"]
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS21"]
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS13"]
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS25"]
