...
#' discharge rating curve for Toolik Lake Inlet for water years 2024-.
...
#   Bobby Hensley (9/4/2024)
#     Modified for TKIN 2024 survey
######################################################################################################################## 
...
filepath <- "N:/Science/AQU/Controls/D18_TKIN_20240731"

#Read in csv file
surveyPtsDF <- read.table(paste0(filepath,"/D18_TKIN_surveyPts_20240731.CSV"),
                          sep = ",",
                          header = TRUE,
...
surveyActiveDate <- "2023-10-01" #Start of WY24
...
dischargeXS1NorthStart<-dischargePointsXS1$N[dischargePointsXS1$name=="IN_DSC_LB_PIN"]
dischargeXS1EastStart<-dischargePointsXS1$E[dischargePointsXS1$name=="IN_DSC_LB_PIN"]
...
dischargeXS1ReferenceDistance <- dischargePointsXS1$DistanceRaw[dischargePointsXS1$name=="IN_DSC_LB_PIN"]
...
staffGaugeMeterMark<-0.67
staffGaugeElevation <- staffGaugePoints$H[grepl("IN_SP_0.67M",staffGaugePoints$name)]  
...
#Sets plot2 settings.  
xAxisTitle2<-list(title="Distance (m)",zeroline=FALSE, range=c(0,20))
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_2"]
geo_controlType_in$controlRight[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_18"]
...
geo_controlType_in$controlLeft[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_LEW"]
geo_controlType_in$controlRight[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_REW"]
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_REW"]
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_MAX_REW"]
...
geo_priorParameters_in$priorActivationStage[1] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_8"]
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_11"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_24"]
