...
#' discharge rating curve for Toolik Lake Outlet for water years 2024-.
...
filepath <- "N:/Science/AQU/Controls/D18_TKOT_20240731"

#Read in csv file
surveyPtsDF <- read.table(paste0(filepath,"/D18_TKOT_surveyPts_20240731.CSV"),
                          sep = ",",
                          header = TRUE,
...
dischargeXS1NorthStart<-dischargePointsXS1$N[dischargePointsXS1$name=="OUT_DSC_MAX_LEW"]
dischargeXS1EastStart<-dischargePointsXS1$E[dischargePointsXS1$name=="OUT_DSC_MAX_LEW"]
...
dischargeXS1ReferenceDistance <- dischargePointsXS1$DistanceRaw[dischargePointsXS1$name=="OUT_DSC_LB_PIN"]
...
staffGaugeElevation <- staffGaugePoints$H[grepl("OUT_SP_0.55",staffGaugePoints$name)]  
...
#Sets plot2 settings.  
xAxisTitle2<-list(title="Distance (m)",zeroline=FALSE, range=c(-5,25))
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "OUT_DSC_6"]
geo_controlType_in$controlRight[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "OUT_DSC_27"]
...
geo_controlType_in$controlLeft[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "OUT_DSC_LEW"]
geo_controlType_in$controlRight[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "OUT_DSC_REW"]
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "OUT_DSC_MAX_LEW"]
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "OUT_DSC_LEW"]
...
geo_priorParameters_in$priorActivationStage[1] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "OUT_DSC_10"]
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "OUT_DSC_16"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "OUT_DSC_LEW"]
