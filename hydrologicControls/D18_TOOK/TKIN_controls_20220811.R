...
#' discharge rating curve for Toolik Inlet for water years 2022-.
...
#   Bobby Hensley (3/20/2023)
#     Modified for TKIN 2022 survey
######################################################################################################################## 
...
filepath <- "N:/Science/AQU/Controls/D18_TKIN_20220811"

surveyPtsDF <- read.table("~/D18_TKIN_surveyPts_20220811.csv",
                          sep = ",",
                          header = T,
                          stringsAsFactors = F,
                          encoding = "UTF-8")
...
dischargeXS1NorthStart<-dischargePointsXS1$N[dischargePointsXS1$name=="IN_DSC_XS_1"]
dischargeXS1EastStart<-dischargePointsXS1$E[dischargePointsXS1$name=="IN_DSC_XS_1"]
...
staffGaugePoints=subset(surveyPtsDF,surveyPtsDF$name=="IN_SP_0.55M")
...
geo_controlType_in$controlLeft[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_MAX_LEW"]
...
geo_priorParameters_in$priorActivationStage[1] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_XS_12"]
geo_priorParameters_in$priorActivationStageUnc[1] <- 0.1

geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_XS_14"]
geo_priorParameters_in$priorActivationStageUnc[2] <- 0.1

geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_RB_PIN"]
