######################################################################################################################## 
#' @title Stage-Discharge Rating Curve Controls Script - D18 - TKIN
...
#' discharge rating curve for Toolik Lake inlet for water years 2023-.
...
filepath <- "N:/Science/AQU/Controls/D18_TKIN_20230804"

surveyPtsDF <- read.table("~/D18_TKIN_surveyPts_20230804.csv",
                          sep = ",",
                          header = T,
                          stringsAsFactors = F,
                          encoding = "UTF-8")
...
dischargeXS1NorthStart<-dischargePointsXS1$N[dischargePointsXS1$name=="IN_DSC_XS23"]
dischargeXS1EastStart<-dischargePointsXS1$E[dischargePointsXS1$name=="IN_DSC_XS23"]
...
dischargeXS1ReferenceDistance <- dischargePointsXS1$DistanceRaw[dischargePointsXS1$name=="IN_DSC_XS23"]
...
floodPlain<-data.frame(name=c("IN_DSC_FLD"),E=c(0.0),N=c(0.0),H=c(996.6),mapCode=c("Transect_DSC"),DistanceRaw=c(30.0),DistanceAdj=c(30.0))
...
#Sets plot2 settings.  
xAxisTitle2<-list(title="Distance (m)",zeroline=FALSE, range=c(-1,31))
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_LEW"]
geo_controlType_in$controlRight[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_REW"]
...
geo_controlType_in$controlLeft[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_LBF"]
geo_controlType_in$controlRight[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_RBF"]
...
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_FLD"]
...
geo_priorParameters_in$priorActivationStage[1] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_XS15"]
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_XS9"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_XS3"]
