...
#
  ...
  stageDischargeCurveInfo <- stageDischargeCurveInfo[stageDischargeCurveInfo$curveID==curveID,]
  gaugeDischargeMeas <- read.table(paste0(DATAWS,"L1_Results_sdrc_gaugeDischargeMeas_pub.txt"), header = T)
  gaugeDischargeMeas <- gaugeDischargeMeas[gaugeDischargeMeas$curveID==curveID,]
  ...
  minCalcH <- -0.123409479781571
  maxCalcH <- 0.459869624227138
  minH <- minCalcH - abs(minCalcH)
  maxH <- maxCalcH + abs(minCalcH)*0.3
